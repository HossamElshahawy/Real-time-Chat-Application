<div class="fixed h-full flex bg-white border lg:shadow-sm overflow-hidden inset-0 lg:top:16 lg:inset-x-2 m-auto lg:h-[80%] rounded-t-lg">
    ...
    <div class="hidden md:grid w-full border-l h-full relative overflow-y-auto" style="contain:content">
        ...
        <div class="m-auto text-center justify-center flex flex-col gap-3">
            ...
            <h4 class="font-medium text-lg">Choose</h4>
        </div>
